        ...
        <div class="row w-100 mx-0">
          <div class="col-lg-4 border border-secondary mx-auto">
            <div class="auth-form-light text-left py-5 px-4 px-sm-5">
              ...
              <h4>Hello! </h4>
              <h6 class="font-weight-light">Please Enter email to continue.</h6>
              <form class="pt-3" action="enterOTP.html" method="post">
                <div class="form-group">
                  <input type="email" name="emailVerify" class="form-control form-control-lg" id="exampleInputEmail1" placeholder="Username" required>
                </div>
