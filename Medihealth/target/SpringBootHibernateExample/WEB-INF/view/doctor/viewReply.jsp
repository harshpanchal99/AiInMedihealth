...
<div class="main-panel">
 ...
 <c:forEach items="${viewDoctorComplains}" var="viewDoctorComplains">
                ...
                <div class="card-body">
                 ...
                 <fieldset>
                    <div class="form-group">
                      <label for="exampleTextarea1">Complain Id: </label><h4 class="card-title">${viewDoctorComplains.complainID}</h4>
                    </div>
                    <div class="form-group">
                      <label for="exampleTextarea1">Subject: </label><h4 class="card-title">${viewDoctorComplains.subject}</h4>
                    </div>
                    <div class="form-group">
                      <label for="exampleTextarea1">Description: </label><h4 class="card-title">${viewDoctorComplains.description}</h4>
                    </div>
                    <div class="form-group">
                      <label for="exampleTextarea1">Complain Date: </label><h4 class="card-title">${viewDoctorComplains.complain_date}</h4>
                    </div>
					<div class="form-group">
                      <label for="exampleTextarea1">Given Reply: </label><h4 class="card-title">${viewDoctorComplains.reply}</h4>
                    </div>
					<div class="form-group">
                      <label for="exampleTextarea1">Replied Date: </label><h4 class="card-title">${viewDoctorComplains.reply_date}</h4>
                    </div>                    
					<div class="form-group">
                      <label for="exampleTextarea1">Status: </label><h4 class="card-title">${viewDoctorComplains.status}</h4>
                    </div>
                  </fieldset>
