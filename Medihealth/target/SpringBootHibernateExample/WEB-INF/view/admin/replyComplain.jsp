        ...
        <div class="content-wrapper">
          <div class="row grid-margin">
            <div class="col-lg-12">
              <div class="card">
                <div class="card-body">
                  <h3 class="card-title">Reply Complain</h3>
                  
                  
                  <f:form  method="post" action="repliedComplain.html" modelAttribute="complainVo"> <!--****************** FORM BEGINS ********************-->
                    <fieldset>
                    
                    <div class="form-group">
                      <label for="exampleTextarea1">Complain Id: </label><h4 class="card-title">${complainVo.complainID}</h4>
                    </div>
                    <div class="form-group">
                      <label for="exampleTextarea1">Subject: </label><h4 class="card-title">${complainVo.subject}</h4>
                    </div>
                    <div class="form-group">
                      <label for="exampleTextarea1">Description: </label><h4 class="card-title">${complainVo.description}</h4>
                    </div>
                    <div class="form-group">
                      <label for="exampleTextarea1">Complain Date: </label><h4 class="card-title">${complainVo.complain_date}</h4>
                    </div>

	
                    <div class="form-group">
                      <label for="exampleTextarea1">Give Reply:</label>
                    	<f:textarea path="reply" class="form-control" id="exampleTextarea1" rows="4" required="true"/>	
                    	
                    	<f:hidden path="complainID" value="${complainVo.complainID}" />
                    </div>
                    
                    <div class="form-group">
                    	<label for="exampleFormControlSelect1">Select Status</label>
                   		
                   		<f:select path="status" class="form-control form-control-sm" id="exampleFormControlSelect1">
                   			<f:option value="pending">Pending</f:option>
                   			<f:option value="solved">Solved</f:option>	                    		
                    	</f:select>
