        ...
        <div class="content-wrapper">
          <div class="row grid-margin">
            <div class="col-lg-12">
              <div class="card">
                <div class="card-body">
                  <h3 class="card-title">Add Disease</h3>
                  <%-- <form class="cmxform" id="commentForm" method="get" action="#">  --%>
                  
                  <!--****************** FORM BEGINS ********************-->
                  
                  <f:form modelAttribute="diseasevo" method="post" action="addDisease.html">
                  
                
                    <fieldset>
 					  <div class="form-group">
                        <label for="cname">Disease Name (required)</label>
                        <f:input path="diseaseName" id="cname" class="form-control" minlength="2" required="true"/>
                        
                        <!-- <input id="cname" class="form-control" name="name" minlength="2" type="text" required> -->
                      </div>	                  
                    <div class="form-group">
                      <label for="exampleTextarea1">Disease Description</label>
                      <f:textarea path="diseaseDescription" class="form-control" id="exampleTextarea1" rows="4" required="true"/>
