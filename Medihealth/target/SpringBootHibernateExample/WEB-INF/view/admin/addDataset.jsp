          ...
          <div class="row grid-margin">
            <div class="col-lg-12">
              <div class="card">
                ...
                <!-- <img src="../../../document/patient.png" height="70px" width="60px"> -->
                <!-- <img src="F:\\AIinMedihealth\\Medihealth\\src\\main\\webapp\\document\\patient.png" height="70px" width="60px"> -->
                
                <h3 class="card-title">Manage Dataset</h3>
                
                <f:form class="cmxform" modelAttribute="datasetVo" method="post" action="addDataset.html" enctype="multipart/form-data">
                  
                    <fieldset>
 					  <div class="form-group">
                        <label for="cname">Dataset Name (required)</label>
                        
                        <f:input path="datasetName" id="cname" class="form-control" minlength="2" required="true" data-validation-required-message="This field is required"/>
                        
                        <!-- <input id="cname" class="form-control" name="name" minlength="2" type="text" required> -->
                      </div>	                  
                    
                    <div class="form-group">
                      <label for="exampleTextarea1">Dataset Description</label>
                      <f:textarea path="datasetDescription" class="form-control" id="exampleTextarea1" rows="4" required="true"/>
                    ...
                    <div class="form-group">
                      ...
                      <input type="file" class="file-upload-browse btn btn-primary" name="file">
