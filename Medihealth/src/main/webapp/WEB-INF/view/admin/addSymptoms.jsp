            ...
            <div class="col-lg-12">
              <div class="card">
                <div class="card-body">
                  ...
                  <f:form  method="post" action="addSymptoms.html" modelAttribute="symptomsVo"> <!--****************** FORM BEGINS ********************-->
                    <fieldset>
                    ...
                    <%--  <div class="form-group">
                        ...
                        <label for="cname">Describe Symptoms(required)</label>
                        
                        <f:input path="symptoms" id="cname" class="form-control" minlength="2" required="true"/>
                      </div>  --%>
                      
                      <div class="form-group">
                      <label for="exampleTextarea1">Symptoms Description</label>
                      
                      <!-- <textarea class="form-control" id="exampleTextarea1" rows="4" required></textarea> -->
                    	<f:textarea path="symptoms" class="form-control" id="exampleTextarea1" rows="4" required="true"/>	
                    	
                   	<f:hidden path="id" value="${symptomsVo.id}" />
