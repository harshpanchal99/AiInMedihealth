                ...
                <div class="col-12">
                  <div class="table-responsive">
                    <table id="order-listing" class="table">
                      ...
                      <tbody>
                        <c:forEach items="${viewAllfeedback}" var="viewAllfeedback">
							<tr>
							<td>${viewAllfeedback.feedbackID }</td>
							<td>${viewAllfeedback.feedbackDescription}</td>
							<td>${viewAllfeedback.rating}</td>
							<td>${viewAllfeedback.loginVO.role}</td>
							<%-- <td>
