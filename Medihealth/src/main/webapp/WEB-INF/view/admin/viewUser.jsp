                ...
                <div class="col-12">
                  <div class="table-responsive">
                    <table id="order-listing" class="table">
                      ...
                      <tbody>
                        <c:forEach items="${viewAllUser}" var="viewAllUser">
							<tr>
							<td>${viewAllUser.registerId }</td>
							<td>${viewAllUser.firstName}</td>
							<td>${viewAllUser.lastName}</td>
							<td>${viewAllUser.age }</td>
							<td>${viewAllUser.gender}</td>
							<td>${viewAllUser.mobileNumber }</td>
							<td>${viewAllUser.address }</td>
							<td>${viewAllUser.loginVo.username }</td>
							<td>${viewAllUser.loginVo.password }</td>
							<td>
