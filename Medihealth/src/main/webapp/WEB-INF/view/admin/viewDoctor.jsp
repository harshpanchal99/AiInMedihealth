                ...
                <div class="col-12">
                  <div class="table-responsive">
                    <table id="order-listing" class="table">
                      ...
                      <tbody>
                        <c:forEach items="${viewAllDoctor}" var="viewAllDoctor">
							<tr>
							<td>${viewAllDoctor.doctorId }</td>
							<td>${viewAllDoctor.firstname}</td>
							<td>${viewAllDoctor.lastname}</td>
							<td>${viewAllDoctor.gender}</td>
							<td>${viewAllDoctor.phone_no }</td>
							<td>${viewAllDoctor.specialization }</td>
							<td>${viewAllDoctor.degree }</td>
							<td>${viewAllDoctor.clinicAddress}</td>
							<td>${viewAllDoctor.timing}</td>
							<td>${viewAllDoctor.experience}</td>
							<td>${viewAllDoctor.loginVo.username }</td>
							<td>${viewAllDoctor.loginVo.password }</td>
							<td>
								<a href="#?id=${viewAllUser.registerId }">
