<nav class="sidebar sidebar-offcanvas" id="sidebar">
        <div class="dropdown sidebar-profile-dropdown">
          <a class="dropdown-toggle d-flex align-items-center justify-content-between" href="#" data-toggle="dropdown" id="profileDropdown1">
            ...
            <div>
                ...
                <div class="nav-profile-designation">USER Person</div>
            </div>
          </a>
        ...
        <ul class="nav">
          ...
          <li class="nav-item">
            <a class="nav-link" href="uploadXray.html">
              <i class="mdi mdi-thermometer-lines menu-icon"></i>
              <span class="menu-title">Upload X-Ray</span>
            </a>
          </li>
          ...
          <li class="nav-item">
            <a class="nav-link" href="#">
              <i class="mdi mdi-thermometer-lines menu-icon"></i>
              <span class="menu-title">Past Reports</span>
            </a>
          </li>
          ...
          <li class="nav-item">
              ...
              <div class="collapse" id="complain-pages">
                <ul class="nav flex-column sub-menu">
                  <li class="nav-item"> <a class="nav-link" href="addComplain.html">Add Complain</a></li>
