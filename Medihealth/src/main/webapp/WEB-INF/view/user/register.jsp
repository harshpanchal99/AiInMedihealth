          ...
          <div class="col-lg-6 border border-secondary mx-auto ">
            <div class="auth-form-light text-left py-5 px-4 px-sm-5">
              ...
              <h6 class="font-weight-light">Signing up is easy. It only takes a few steps</h6>
               ...
               <f:form class="cmxform" method="post" action="userInsert.html" modelAttribute="userRegisterVo">             <!-- CHANGED FROM HERE  -->
                ...
                <div class="form-group">
                    <label for="clinicNumber">Age (required)</label>
                    <f:input path="age" id="clinicNumber" class="form-control" name="clinicNum" minlength="2" type="text" />
                    <!-- <input id="clinicNumber" class="form-control" name="clinicNum" minlength="2" type="text" required> -->
                </div>
                <div class="form-group">
                    <label for="clinicAddress">Address(required)</label>
                    <f:input path="address" id="clinicAddress" class="form-control" minlength="2" type="text"/>
                    <!-- <input id="clinicAddress" class="form-control" name="clinicAdd" minlength="2" type="text" required> -->
                </div>
                <div class="form-group">
                    <label for="time">Phone Number(required)</label>
                    <f:input path="mobileNumber" id="time" class="form-control" minlength="2" type="text"  />
                ...
                <div class="form-group">
                    ...
                    <f:input path="loginVo.username" id="cemail" class="form-control" onblur="fun2()" required="true"/>
